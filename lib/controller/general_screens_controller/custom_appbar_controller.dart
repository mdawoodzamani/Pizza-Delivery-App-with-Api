...
class CustomAppBarController extends GetxController {
  DeliveryListScreenController deliveryListScreenController =
      Get.find(tag: kDeliveryListController);
  ...
  Future<void> getAddressFromLatLong(Position position) async {
    ...
    addressModel.value = AddressModel.forDelivery(
        street: place.street ?? '',
        yourAddress: place.administrativeArea ?? '',
        yourCity: place.locality ?? '',
        youZip: place.postalCode ?? '',
        floor: '',
        company: '',
        clientName: addressModel.value.clientName,
        yourPhone: addressModel.value.yourPhone,
        yourEmail: addressModel.value.yourEmail);
